...
public class RNVoipConfig {
    public static WritableMap callNotificationConfig(ReadableMap json) {
        ...
        if(checkType(json , "roomid", "String")){
            config.putString("roomid", json.getString("roomid"));
        }else{
            config.putString("roomid", "");
        }
        if(checkType(json , "type", "String")){
            config.putString("type", json.getString("type"));
        }else{
            config.putString("type", "1");
        }
        return config;
    }
